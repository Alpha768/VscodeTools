...
foreach(_cmake_expected_target IN ITEMS LLVMTestingSupport FileCheck llvm-PerfectShuffle count not yaml-bench lli-child-target gtest gtest_main KillTheDoctor)
...
set_target_properties(LLVMTestingSupport PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "D:/SoftWareDemoStudy/cclsBuild/llvm_build/llvm/Release/lib/LLVMTestingSupport.lib"
  )
...
set_target_properties(FileCheck PROPERTIES
  IMPORTED_LOCATION_RELEASE "D:/SoftWareDemoStudy/cclsBuild/llvm_build/llvm/Release/bin/FileCheck.exe"
  )
...
set_target_properties(llvm-PerfectShuffle PROPERTIES
  IMPORTED_LOCATION_RELEASE "D:/SoftWareDemoStudy/cclsBuild/llvm_build/llvm/Release/bin/llvm-PerfectShuffle.exe"
  )
...
set_target_properties(count PROPERTIES
  IMPORTED_LOCATION_RELEASE "D:/SoftWareDemoStudy/cclsBuild/llvm_build/llvm/Release/bin/count.exe"
  )
...
set_target_properties(not PROPERTIES
  IMPORTED_LOCATION_RELEASE "D:/SoftWareDemoStudy/cclsBuild/llvm_build/llvm/Release/bin/not.exe"
  )
...
set_target_properties(yaml-bench PROPERTIES
  IMPORTED_LOCATION_RELEASE "D:/SoftWareDemoStudy/cclsBuild/llvm_build/llvm/Release/bin/yaml-bench.exe"
  )
...
set_target_properties(lli-child-target PROPERTIES
  IMPORTED_LOCATION_RELEASE "D:/SoftWareDemoStudy/cclsBuild/llvm_build/llvm/Release/bin/lli-child-target.exe"
  )
...
set_target_properties(gtest PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "D:/SoftWareDemoStudy/cclsBuild/llvm_build/llvm/Release/lib/gtest.lib"
  )
...
set_target_properties(gtest_main PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "D:/SoftWareDemoStudy/cclsBuild/llvm_build/llvm/Release/lib/gtest_main.lib"
  )
...
set_target_properties(KillTheDoctor PROPERTIES
  IMPORTED_LOCATION_RELEASE "D:/SoftWareDemoStudy/cclsBuild/llvm_build/llvm/Release/bin/KillTheDoctor.exe"
  )
